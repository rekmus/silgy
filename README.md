...
For heavy-loaders or third-party callers there's the ASYNC facility, which allows to split (or move) the functionality to multiple service processes, to avoid gateway process blocking.
